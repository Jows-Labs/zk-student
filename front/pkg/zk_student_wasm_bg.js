 ...
 * @returns {any}
 */
export function parse_cert(der) {
    const ptr0 = passArray8ToWasm0(der, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_cert(ptr0, len0);
    if (ret[2]) {
 ...
 * @param {Uint8Array} der
 * @param {Uint8Array} issuer_pubkey_der
 */
export function verify_cert(der, issuer_pubkey_der) {
    const ptr0 = passArray8ToWasm0(der, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(issuer_pubkey_der, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_cert(ptr0, len0, ptr1, len1);
    if (ret[1]) {
